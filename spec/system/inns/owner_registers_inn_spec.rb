...
describe 'Inn Owner visits the inn creation page' do
  it 'only if authenticated' do
    ...
    # assert
    expect(current_path).to eq new_inn_owner_session_path
  end
  ...
  it "and sees the fields to input the inn's data" do
    # arrange
    owner = InnOwner.create!(email: 'test@gmail.com', password: 'password')
  ...
  it 'but fails to create a inn with missing data for the inn' do 
    # arrange
    owner = InnOwner.create!(email: 'test@gmail.com', password: 'passwordftw')
  ...
  it 'but fails to create a inn without a valid address' do
    # arrange
    billy = InnOwner.create!(email: 'billy@gmail.com', password: 'password')
