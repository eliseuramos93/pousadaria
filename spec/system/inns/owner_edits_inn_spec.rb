...
describe 'Owner visits inn edit page' do
  ...
  it 'and only sees the edit button for an inn they own' do
    # arrange
    billy = InnOwner.create!(email: 'billy@mail.com', password: 'password')
    teddy = InnOwner.create!(email: 'teddy@mail.com', password: 'password1')
